...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<AppUserRole> appUserRoles) {
        ...
        claims.put("auth",
                appUserRoles.stream().map(s -> new SimpleGrantedAuthority(s.getAuthority())).filter(Objects::nonNull)
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new CustomAuthException(TOKEN_ERROR, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
